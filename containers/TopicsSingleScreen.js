...
const moreOptionsIcons = {
	...
	split: require("../assets/img/split.png"),
...
class TopicsSingleScreen extends Component {
	...
	renderReplyIcon = ({t, colors, global, topic}) => {
		...
		return (
			...
			>
				<Icon
					icon={require("../assets/img/reply.png")}
					webIcon={"IconReply"}
	...
	renderHeaderRight = ({headerColor, ...rest}) => {
		...
		return (
			...
			this.state.topicActionsOrder.length > 1 && (
				<AuthWrapper>
					<IconButton
						icon={require("../assets/img/horizontal-dots.png")}
			...
			<ScrollView style={global.container}>
				...
				<EmptyList
					...
					emptyText={{
						...
						icon: require("..//assets/img/empty-replies.png"),
